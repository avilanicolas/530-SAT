...
public class AppTest extends TestCase {
   ...
   public void demo() {
      ...
      assertEquals(DecisionDiagramLeaf.UNSATISFIABLE, complex.assume(varA, BooleanDDType.valueOf(false)));
      ...
      // variables
      assertEquals(c, complex.assume(varA, BooleanDDType.valueOf(true)).assume(varB, BooleanDDType.valueOf(true)).assume(varD, BooleanDDType.valueOf(true)));
      // Or reduce it to trivially satisfiable or unsatisfiable
      assertEquals(DecisionDiagramLeaf.SATISFIABLE, complex.assume(varA, BooleanDDType.valueOf(true))
            .assume(varB, BooleanDDType.valueOf(true)).assume(varC, BooleanDDType.valueOf(true)).assume(varD, BooleanDDType.valueOf(true)));
