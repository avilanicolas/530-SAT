...
import com.csc530.sat.condition.IntegerEQCondition;
...
public class IntegerTheoryTest {
   ...
   public void testMixedTheory() {
      ...
      DecisionDiagramNode<Integer> yDiagram = DecisionDiagramNode.of(Y,
            IntegerEQCondition.create(4));
      DecisionDiagramNode<Boolean> zDiagram = DecisionDiagramNode.of(Z, BooleanCondition.isTrue());
      DecisionDiagramNode<Boolean> wDiagram = DecisionDiagramNode.of(W, BooleanCondition.isTrue());
