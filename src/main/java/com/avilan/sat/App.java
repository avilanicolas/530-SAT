...
public class App {
   public static void main(String[] args) {
      ...
      DecisionDiagram complex = aAndB.and(c.or(xor(d, a)));
   ...
   private static DecisionDiagram xor(final DecisionDiagram a, final DecisionDiagram b) {
      return a.and(b.not()).or(b.and(a.not()));
   }

   private static Map<SATVariable, Boolean> assignment(final Object... assignments) {
